...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* ISO 60 layout by SebSemmi (ISO German macOS keyboard layout shown)
   *
   ...
   * |-----------------------------------------------------------------------------------------|
   * | LCTL  | LOPT  | LCMD  |            Space                  | RCMD  | ROPT  | APFN | RCTL |
   * `-----------------------------------------------------------------------------------------'
   */
  [0] = LAYOUT_60_iso(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,                                      KC_RGUI, KC_RALT, KC_APFN, KC_RCTL
  ),
  ...
  [1] = LAYOUT_60_iso(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_BSPC,                                     KC_RGUI, KC_RALT, KC_APFN, KC_RCTL
  ),
