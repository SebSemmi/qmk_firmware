...
*/
	...
	[1] = LAYOUT_75_iso(
        ...
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT, KC_UP, KC_TRNS, 
        KKC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_RGUI, KC_RALT, KC_APFN, KC_LEFT, KC_DOWN, KC_RGHT)
};
